...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="{{ asset('pullo/https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css')}}">
      <!-- owl stylesheets --> 
      ...
      <link rel="stylesheet" href="{{ asset('pullo/https://cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.min.css')}}" media="screen">
      <!--[if lt IE 9]>
   ...
   <body class="main-layout">
				...
				<div class="col-sm-9">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                           ...
                           <a class="nav-item nav-link last" href="#"><img src="{{ asset('pullo/images/search_icon.png')}}"></a>
                           <a class="nav-item nav-link last" href="contact.html"><img src="{{ asset('pullo/images/shop_icon.png')}}"></a>
                        </div>
                    </div>
                    </nav>
				</div>
	    ...
	    <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
					...
					<div class="col-sm-5">
						<div class="shoes_img"><img src="{{ asset('pullo/images/running-shoes.png')}}"></div>
					</div>
				</div>
                </div>
    	    	...
    	    	<div class="row">
    	    		<div class="col-md-6">
    	    			<div class="about-img">
    	    				...
    	    				<div class="shoes-img"><img src="{{ asset('pullo/images/shoes-img1.png')}}"></div>
    	    		...
    	    		<div class="col-md-6">
    	    			<div class="about-img2">
    	    				<div class="shoes-img2"><img src="{{ asset('pullo/images/shoes-img2.png')}}"></div>
    	    				<p class="sport_text">Men Sports</p>
    	    				<div class="dolar_text">$<strong style="color: #f12a47;">90</strong> </div>
    	    				<div class="star_icon">
    	    					<ul>
    ...
    <div class="collectipn_section_3 layuot_padding">
    	<div class="container">
    		<div class="racing_shoes">
    			<div class="row">
    				<div class="col-md-8">
    					<div class="shoes-img3"><img src="{{ asset('pullo/images/shoes-img3.png')}}"></div>
    				</div>
    				<div class="col-md-4">
    		...
    		<div class="row">
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					...
    					<div class="shoes_icon"><img src="{{ asset('pullo/images/shoes-img4.png')}}"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="{{ asset('pullo/images/star-icon.png')}}"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Best Shoes </p>
    					<div class="shoes_icon"><img src="{{ asset('pullo/images/shoes-img5.png')}}"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="{{ asset('pullo/images/star-icon.png')}}"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Best Shoes </p>
    					<div class="shoes_icon"><img src="{{ asset('pullo/images/shoes-img6.png')}}"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="{{ asset('pullo/images/star-icon.png')}}"></a></li>
    		...
    		<div class="row">
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					...
    					<div class="shoes_icon"><img src="{{ asset('pullo/images/shoes-img7.png')}}"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="{{ asset('pullo/images/star-icon.png')}}"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Sports Shoes</p>
    					<div class="shoes_icon"><img src="{{ asset('pullo/images/shoes-img8.png')}}"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="{{ asset('pullo/images/star-icon.png')}}"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Sports Shoes</p>
    					<div class="shoes_icon"><img src="{{ asset('pullo/images/shoes-img9.png')}}"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="{{ asset('pullo/images/star-icon.png')}}"></a></li>
    	...
    	<div class="container">
    		<div class="mail_section">
    			<div class="row">
    				...
    				<div class="col-sm-6 col-lg-2">
    					<div class="footer-logo"><img src="{{ asset('pullo/images/phone-icon.png')}}"><span class="map_text">(71) 1234567890</span></div>
    				</div>
    				<div class="col-sm-6 col-lg-3">
    					<div class="footer-logo"><img src="{{ asset('pullo/images/email-icon.png')}}"><span class="map_text">Demo@gmail.com</span></div>
    				</div>
    				<div class="col-sm-6 col-lg-3">
    	    ...
    	    <div class="footer_section_2">
		        <div class="row">
    		        ...
    		        <div class="col-sm-4 col-lg-2">
    		        	...
    		        	<div class="image-icon"><img src="{{ asset('pullo/images/map-icon.png')}}"><span class="pet_text">No 40 Baria Sreet 15/2 NewYork City, NY, United States.</span></div>
    		        </div>
	...
	<div class="copyright">2019 All Rights Reserved. <a href="https://html.design">Free html  Templates</a></div>
      ...
      <script src="{{ asset('pullo/https:cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.min.js')}}"></script>
      <script>
